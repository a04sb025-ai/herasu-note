...
このアプリは依存パッケージなしの静的Webアプリとしてビルドし、生成された `dist/` を公開できます。GitHub Pagesのプロジェクトサイト（例：`https://a04sb025-ai.github.io/herasu-note/`）で動くよう、JavaScript・CSS・manifest・アイコン・Service Workerは相対パスで参照しています。
...
5. 公開後、`https://a04sb025-ai.github.io/herasu-note/` を開きます。
